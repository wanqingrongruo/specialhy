//
//  RNBaseTableViewController.swift
//  SpecialHoyoServicer
//
...
class RNBaseTableViewController: UIViewController {
...
extension RNBaseTableViewController: DZNEmptyDataSetSource, DZNEmptyDataSetDelegate{
