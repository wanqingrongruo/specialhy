...
@objc public class DateTimePicker: UIView {
    ...
    public var doneButtonBackgroundColor = UIColor(red: 0, green: 22.0/255.0, blue: 39.0/255.0, alpha: 1) {
        didSet {
            doneButton.backgroundColor = doneButtonBackgroundColor
        }
    }
    public var doneButtonFont = 13 {
        didSet {
            doneButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: CGFloat(doneButtonFont))
        }
    }
